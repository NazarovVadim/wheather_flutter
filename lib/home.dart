...
class Wheather {
  ...
  String getForecastInfo(data, index){
    String info = data[index+1]['weather'][0]['main'];
                                ...
                                return Column(
                                  ...
                                  children: [
                                    Padding(
                                      ...
                                      child: Text(
                                        snapshot.data!.getForecastHours(index),
                                        style: const TextStyle(fontSize: 22, color: Colors.white),
                                      ),
                                    ),
                                    SvgPicture.asset(
                                        'assets/${snapshot.data!.getForecastInfo(snapshot.data!.list, index)}.svg',
                                      height: 40,
                                    ),
                                    Padding(
                                      padding: const EdgeInsets.symmetric(vertical: 10, horizontal: 10),
                                      child: Text(
                                        snapshot.data!.getForecastTemp(snapshot.data!.list, index),
                                        style: const TextStyle(fontSize: 22, color: Colors.white),
                                      ),
                                    )
